...
const ResourcePackDataInfoPacket = amethystnode("network/minecraft/protocol/ResourcePackDataInfoPacket");
const ResourcePackStackPacket = amethystnode("network/minecraft/protocol/ResourcePackStackPacket");
const ResourcePackChunkRequestPacket = amethystnode("network/minecraft/protocol/ResourcePackChunkRequestPacket");
const ResourcePackChunkDataPacket = amethystnode("network/minecraft/protocol/ResourcePackChunkDataPacket");
...
const DataPacketReceiveEvent = amethystnode("event/server/DataPacketReceiveEvent");

const Chunk = amethystnode("level/chunk/Chunk");

const TextPacket = amethystnode("network/minecraft/protocol/TextPacket");

const ResourcePack = amethystnode("resourcepacks/ResourcePack");
