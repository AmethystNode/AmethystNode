...
const Config = amethystnode("utils/Config");

const PluginManager = amethystnode("plugin/PluginManager");
const SourcePluginLoader = amethystnode("plugin/SourcePluginLoader");
const ScriptPluginLoader = amethystnode("plugin/ScriptPluginLoader");

const RakNetAdapter = amethystnode("network/RakNetAdapter");
const BatchPacket = amethystnode("network/minecraft/protocol/BatchPacket");

const CommandMap = amethystnode("command/CommandMap");
const ConsoleCommandReader = amethystnode("command/ConsoleCommandReader");
const HelpCommand = amethystnode("command/defaults/HelpCommand");
const StopCommand = amethystnode("command/defaults/StopCommand");
const PluginsCommand = amethystnode("command/defaults/PluginsCommand");

const Player = amethystnode("player/Player");
const PlayerList = amethystnode("player/PlayerList");

const ResourcePackManager = amethystnode("resourcepacks/ResourcePackManager");

const Level = amethystnode("level/Level");
const GeneratorManager = amethystnode("level/generator/GeneratorManager");
const FlatGenerator = amethystnode("level/generator/FlatGenerator");

const SFS = amethystnode("utils/SimpleFileSystem");
...
class Server {
    ...
    constructor(amethystnode, logger, paths){
        this.initVars();

        this._pocketnode = amethystnode;
        ...
        if(!SFS.fileExists(this._paths.data + "amethystnode.json")){
            SFS.copy(this._paths.file + "amethystnode/resources/amethystnode.json", this._paths.data + "amethystnode.json");
        }
        this._config = new Config(this.getDataPath() + "amethystnode.json", Config.JSON, {});
        ...
        this.getLogger().info("AmethystNode is distributed under the GPLv3 License.");
