...
const PluginLoader = amethystnode("plugin/PluginLoader");
const PluginManifest = amethystnode("plugin/PluginManifest");

const Listener = amethystnode("event/Listener");
const EventManager = amethystnode("event/EventManager");
                ...
                FileSystem.readdirSync(directory).forEach(file => {
                    ...
                    try {
                        ...
                        if(manifest instanceof PluginManifest){
                            ...
                            if(name.indexOf("amethystnode") !== -1 || name.indexOf("minecraft") !== -1 || name.indexOf("mojang") !== -1){
