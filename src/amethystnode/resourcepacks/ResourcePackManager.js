...
const ZippedResourcePack = amethystnode("resourcepacks/ZippedResourcePack");
...
class ResourcePackManager {
    ...
    constructor(server, path){
        ...
        if(!SFS.fileExists(path + "resource_packs.json")){
            SFS.copy(server.getFilePath() + "amethystnode/resources/resource_packs.json", path + "resource_packs.json");
        }
